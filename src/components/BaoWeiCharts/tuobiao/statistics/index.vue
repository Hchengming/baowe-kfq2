    ...
    >
      <div class="statisticsBox">
          ...
          <div class="box theme-border-color">
            ...
            <div class="right">
              ...
              >
                ...
                <i class="iconfont icondangan theme-color" />
                <div class="t_list">
                  <ul>
                    <li
        ...
        >
          ...
          <!-- 折线图、条形图、柱状图、饼图、环图 -->
          <bw-line
            v-if="bwLineType.indexOf(settingForm.displayMode) > -1&&isCharts()"
            :data="statisticsAll.data"
            :chart-columns="nowClums()"
            :title-show="false"
...
import { dataMixins, childMixins, screenMixins, destailMixins } from './statisticsMixins'
...
export default {
  ...
  methods: {
    // 当前模块是否为图表组件判断
    isCharts() {
      const offon = !!(!this.settingForm.moduleType || this.settingForm.moduleType === '0')
      return offon
    },
    // 表单内容区域高度
    boxHeight() {
