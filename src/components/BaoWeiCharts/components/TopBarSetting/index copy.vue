    ...
    <el-form ref="topBaSettingForm"
      ...
      <div class="setting-box">
        <el-row type="flex"
          ...
          <el-col v-if="form.bgType != '2'"
                  :span="4">
            <el-form-item label="背景一"
                          prop="bg1">
              <el-input v-model="form.bg1"
                        size="small"
                        placeholder="背景颜色" />
            </el-form-item>
          </el-col>
          <el-col v-if="form.bgType === '1'"
                  :span="4">
            <el-form-item label="背景二"
                          prop="bg2">
              <el-input v-model="form.bg2"
                        size="small"
                        placeholder="背景颜色" />
            </el-form-item>
          </el-col>
        ...
        <param-key-config :item-api-data="itemApiData"
          ...
          <div slot="keys"
            ...
            <ul class="top-bar-setting-list">
              ...
              <li v-for="(item, index) in bgColorSettingData"
                  :key="index">
