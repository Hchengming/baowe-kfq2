  ...
  <div>
    ...
    >
      ...
      <div class="screenForm-top">
        <span>是否显示查询按钮</span>
        <el-radio-group v-model="isShowInsertButton" size="small">
              ...
              >
                ...
                >
                  ...
                  <el-input-number
                    ...
                    controls-position="right"
                    :disabled="
                      items.type === 'radio' || items.type === 'checkbox'
                    "
                    :precision="0"
                    size="small"
                  />
                  ...
                  <el-select
                    ...
                    :placeholder="item.title"
                  >
                    <el-option label="默认样式" value="0" />
                    <el-option label="带有边框" value="1" />
                    <el-option label="按钮组" value="2" />
                  </el-select>
                  <!-- 日期选择器显示样式选择 -->
                  <el-select
                    v-if="item.key == 'styleType' && items.type === 'date'"
                    v-model="items[item.key]"
                    size="small"
                    :placeholder="item.title"
                  >
                  ...
                  <el-select
                    ...
                    v-model="items[item.key]"
                    :disabled="
                      items.type !== 'date' && items.type !== 'dateTime'
                    "
                    size="small"
                    :placeholder="item.title"
                  ...
                  <div v-if="item.key == 'changeData'">
                    <el-input
                      ...
                      :disabled="
                        ['input', 'number', 'textarea'].indexOf(items.type) > -1
                      "
                      readonly
                      size="small"
                  ...
                  <div v-if="item.title == '操作'" class="rightIcon">
                    ...
                    <i
                      :class="[
                        ...
                        'iconxiayi',
                        'theme-color',
                        { disabled: screenData.length - 1 == index },
                      ]"
                      @click="
                        sortNext(items, index, screenData.length - 1 == index)
                      "
                    />
                    <i
    ...
    <settingData ref="settingData" @itemDataConfig="itemDataConfig" />
  </div>
</template>
<script>
