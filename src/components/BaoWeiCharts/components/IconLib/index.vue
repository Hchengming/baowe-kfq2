<template>
	<div class="icon-container">
		<el-dialog title="图标库" :show-close="false" :close-on-press-escape="false" :close-on-click-modal="false" @open="open" 
		:visible.sync="showSelectIcon" width="60%" center>
			<ul class="icon-list">
				<li v-for="(item,index) in iconList" :class="{active: currentIndex===index}" :key="item.className" @click="selectIcon(item,index)">
