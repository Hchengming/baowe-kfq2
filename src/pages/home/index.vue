...
export default {
  ...
  data() {
    return {
      settingConfig: {
        commonUrl: 'http://172.1.103.118:4000', // 配置数据接口公共部分
        dataUrl: 'http://172.1.103.118:4000', // 图表、组件数据公共接口
