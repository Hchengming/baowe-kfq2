  ...
  data() {
    return {
      ...
      settingConfig: {
        ...
        // dataUrl: 'http://23.36.25.161:8086', // 图表、组件数据公共接口
        systemPermissions: 'admin', // 权限管理
        theme: '1', // 当前已配置主题 0：白色背景 1：深色背景
        // 获取当前项目菜单接口
        // http://23.36.123.128/api/applicationcenter/function/findOwnerAll?key=0a3724b5-74cf-4ef1-b7b2-93d2619d6270&type=1
        getMenuUrl:
          'http://23.36.123.128/api/applicationcenter/function/findAll?key=0a3724b5-74cf-4ef1-b7b2-93d2619d6270&type=1',
        // 获取项目所有接口的接口路径
        getInterfaceUrl:
          'http://23.36.123.128/api/shareservice/app/authorizeListByApp?uuid=fb054e83-9bb3-4385-a3c7-53a020434506',
